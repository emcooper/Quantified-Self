...
/***/ (function(module, exports, __webpack_require__) {
	...
	function retrieveFoods() {
	  $.get(`${api}/api/v1/foods`).then(function (foods) {
...
/***/ (function(module, exports) {
	...
	const apiUrl = "https://calory-tracker.herokuapp.com/api/v1";
	...
	function renderFoodTable(foods) {
	  $("#foods-table-headers").append("<h3 class='text-center'>Foods</h3><br>" + "<p>Add Selected to:</p>");

	  $("#foods-table").append("<table class='table table-bordered'>" + "<thead><tr><th></th><th>Name</th><th>Calories</th></tr></thead><tbody>" + generateFoodRows(foods) + "</tbody></table>");
	}
